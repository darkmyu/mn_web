...
function MobileBottomNavigation() {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 flex h-[calc(3.75rem+env(safe-area-inset-bottom))] justify-evenly border-t border-zinc-200 bg-zinc-50 px-4 pb-[env(safe-area-inset-bottom)] lg:hidden dark:border-zinc-700 dark:bg-zinc-900">
