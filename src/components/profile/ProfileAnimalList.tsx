    ...
    <div className="flex items-stretch gap-4">
      {animals.items.map((animal) => (
        <Popover.Root key={animal.id}>
          ...
          <Popover.Portal>
            <Popover.Content
              className="w-2xs rounded-lg bg-zinc-50 p-4 shadow-2xl/50 outline-none dark:bg-zinc-800"
              sideOffset={12}
              align="start"
            >
              ...
              <Popover.Arrow className="fill-zinc-50 dark:fill-zinc-800" width={16} height={8} />
            </Popover.Content>
          </Popover.Portal>
        </Popover.Root>
      ))}
