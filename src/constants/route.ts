...
export const ROUTE_HOME_LATEST_PAGE = '/latest';
...
export const API_ROUTE_OAUTH_NAVER = `${process.env.NEXT_PUBLIC_API_URL}/api/v1/auth/naver`;
export const API_ROUTE_OAUTH_KAKAO = `${process.env.NEXT_PUBLIC_API_URL}/api/v1/auth/kakao`;
